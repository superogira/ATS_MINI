...
void setup()
{
  ...
  while ((WiFi.status() != WL_CONNECTED) && wificheck <= 60){
    Serial.print(".");
    wificheck++;
    delay(500);
  }
...
String SendHTML(){
  ...
  ptr +="<br><div id='setVolume'><FORM METHOD='POST'action='/setvolume'><label for='Volume'>0 - 63 :</label><input type='number' min='0' max='63' name='setVolume'><input type='submit' value='Set Volume'></form></div>";
