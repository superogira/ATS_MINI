...
String WifiConnection(){
  ...
  ptr +="<br><div id='setAviationBand'><form action=\"/config\" method=\"POST\"><label for=\"aviationband\">Aviation Band Converter Model (100,110) : </label><input type=\"number\" min='100' max='110' name=\"setAviationBandConverter\" id=\"setaviationbandmodel\"> <input type='submit' value='Set Model'></form></div><br>";
