...
String SendHTML(){
  ...
  ptr +="</script>";
  ptr +="<script type=\"text/javascript\">";
  ptr +="var smeterGuage = 0; var lastMode = \"\"; $(function(){setInterval(function(){var getData=$.ajax({url:\"./data\",async:true,success:function(getData){const data = getData.split(\" \");$(\"div#Mode\").html(data[0]);$(\"div#Frequency\").html(data[1]+\"<span class='superscript' id='Tail'></span>\");$(\"span#Tail\").html(data[2]);$(\"div#Volume\").html(data[4]);smeterGuage = data[3];if (data[0] == \"FM\" && lastMode != \"FM\") {lastMode = \"FM\"; $(\"div#setFreq\").html(\"<label for='frequency'>64.00 - 108.00 : </label><input type='number' min='64' max='108' step='.01' name='setFrequency'><input type='submit' value='Set Frequency'></form>\");$(\"div#setBFO\").html('');} else if ((data[0] == (\"USB\" || \"LSB\") && lastMode != \"OTHER\") || (data[0] == \"AM\" && data[5] == 0 && lastMode != \"OTHER\")) {lastMode = \"OTHER\";$(\"div#setFreq\").html(\"<label for='frequency'>150 - 30000 : </label><input type='number' min='150' max='30000' name='setFrequency'><input type='submit' value='Set Frequency'></form>\");$(\"div#setBFO\").html(\"<label for='bfo'>0 - 999 : </label><input type='number' min='0' max='999' name='setBFO'><input type='submit' value='Set BFO'></form><br><br>\");} else if (data[0] == \"AM\" && data[5] != 0 && lastMode != \"AIR\") {lastMode = \"AIR\";$(\"div#setFreq\").html(\"<label for='frequency'>108.000 - 138.000 : </label><input type='number' min='108' max='138' step='.001' name='setFrequency'><input type='submit' value='Set Frequency'></form>\");} else {}}}).responseText;},";
  ptr +=ajaxInterval;
  ptr +=");});";
  ptr +="</script>";
