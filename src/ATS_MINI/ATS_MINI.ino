...
String SendHTML(){
  ...
  ptr +="} else if (data[0] == \"AM\" && data[5] != 0 && webCurrentMode != \"AIR\") {webCurrentMode = \"AIR\";$(\"div#setFreq\").html(\"<label for='frequency'>108.000 - 138.000 : </label><input type='number' min='108' max='138' step='.001' name='setFrequency'> <input type='submit' value='Set Frequency'></form>\");} else {}}}).responseText;},";
  ptr +=ajaxInterval;
  ptr +=");});";
  ptr +="</script>";
